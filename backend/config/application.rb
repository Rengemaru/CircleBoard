...
# require "active_storage/engine"  # 使わない(CLAUDE.md §1)
require "action_controller/railtie"
require "action_mailer/railtie"
# require "action_mailbox/engine"  # 使わない(CLAUDE.md §1)
# require "action_text/engine"  # 使わない(CLAUDE.md §1)
require "action_view/railtie"
# require "action_cable/engine"  # 使わない(CLAUDE.md §1)
